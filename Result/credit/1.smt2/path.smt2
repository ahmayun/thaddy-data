...
(assert (= input1_P1 (str.++ (str.++ (str.++ input1_P1_d0 (str.++ "," input1_P1_d1)) (str.++ "," input1_P1_d2)) (str.++ "," input1_P1_d3))))
(assert (= input1_P2 (str.++ (str.++ (str.++ input1_P2_d0 (str.++ "," input1_P2_d1)) (str.++ "," input1_P2_d2)) (str.++ "," input1_P2_d3))))
(assert  (and (=  x4_P1 ( select  x10 0 ) )  (and (=  x4_P2 ( select  x10 1 ) )  (and (=  x3_P1 input1_P1_d3 )  (and (=  x4_P1 ( str.to_int input1_P1_d1  ) )  (and (=  x3_P2 input1_P2_d3 )  (and (=  x4_P2 ( str.to_int input1_P2_d1  ) ) (=  x15 ( str.++ ( str.++ ( str.++  ""  x3 )  ":"  ) ( str.from_int x6  ) ) ) ) ) ) ) ) ) )
