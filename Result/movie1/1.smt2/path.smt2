...
(assert (= input1_P1 (str.++ (str.++ (str.++ (str.++ input1_P1_d0 (str.++ "," input1_P1_d1)) (str.++ "," input1_P1_d2)) (str.++ "," input1_P1_d3)) (str.++ "," input1_P1_d4))))
(assert (= input1_P2 (str.++ (str.++ (str.++ (str.++ input1_P2_d0 (str.++ "," input1_P2_d1)) (str.++ "," input1_P2_d2)) (str.++ "," input1_P2_d3)) (str.++ "," input1_P2_d4))))
(assert  (and (=  x6_P1 ( select  x12 0 ) )  (and (=  x6_P2 ( select  x12 1 ) )  (and (=  x5_P1 input1_P1_d2 )  (and (=  x6_P1 1 )  (and (=  x5_P2 input1_P2_d2 )  (and (=  x6_P2 1 )  (and (=  x11 (+  x8 x10 ) ) (=  x15 ( str.++ ( str.++ ( str.++  ""  x5 )  ":"  ) ( str.from_int x11  ) ) ) ) ) ) ) ) ) ) )
